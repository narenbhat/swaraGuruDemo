const violinNotes = function(selector, tuner) {
    this.tuner = tuner
  ...
  violinNotes.prototype.createNotes = function() {
    const minOctave = 2
    const maxOctave = 5
  ...
  violinNotes.prototype.active = function($note) {
    this.clearActive()
  ...
  violinNotes.prototype.clearActive = function() {
  ...
  violinNotes.prototype.update = function(note) {
  ...
  violinNotes.prototype.toggleAutoMode = function() {
    if (this.isAutoMode) {
      this.clearActive()
    }
